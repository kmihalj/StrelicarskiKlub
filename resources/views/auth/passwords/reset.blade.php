...
@section('content')
    <div class="row justify-content-center">
        <div class="col-lg-8 col-xl-7">
            <div class="card">
                <div class="card-header bg-danger fw-bolder text-white">Postavljanje nove lozinke</div>
                ...
                <div class="card-body bg-white shadow">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="row mb-3">
                            <label for="password" class="col-md-4 col-form-label text-md-end">Nova lozinka</label>
